...
public class CharArrayCompilerTest {
    ...
    public void executesCharArrayOnJvm() throws Exception {
        ...
        Process process = new ProcessBuilder(new File(new File(System.getProperty("java.home"), "bin"), "java.exe").getPath(), "-cp", generator.getOutputDir().getPath(), "CharArrayRuntime").redirectErrorStream(true).start();
