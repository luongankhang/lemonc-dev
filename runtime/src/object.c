...
void lemon_retain(lemon_object *object) { if (object == NULL || object->refcount == 0) lemon_panic("retain of invalid object"); object->refcount++; }
void lemon_release(lemon_object *object) { if (object == NULL || object->refcount == 0) lemon_panic("double release or invalid object"); if (--object->refcount == 0) lemon_destroy(object); }
